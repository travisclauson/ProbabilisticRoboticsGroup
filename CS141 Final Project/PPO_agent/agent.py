...
from PPO_agent.network import FeedForwardNN
from PPO_agent.eval_policy import eval_policy
import time
# from ppo import PPO
...
def train(env, hyperparameters, actor_model, critic_model, writeToFile = False):
	"""
		Trains the model.
